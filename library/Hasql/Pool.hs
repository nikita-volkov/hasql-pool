...
-- | Release all connections in the pool. Connections currently in use will
-- get released right after finishing being used.
--
...
-- with 'Session.ClientError'the connection will eventually get
-- reestablished.
