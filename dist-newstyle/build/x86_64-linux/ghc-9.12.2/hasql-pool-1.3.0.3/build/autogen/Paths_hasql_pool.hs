...
-- at runtime using the environment variable hasql_pool_bindir.
...
-- environment variable hasql_pool_libdir.
...
-- using the environment variable hasql_pool_dynlibdir.
...
-- runtime using the environment variable hasql_pool_datadir.
...
-- using the environment variable hasql_pool_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/hasql-pool-1.3.0.3-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/hasql-pool-1.3.0.3"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/hasql-pool-1.3.0.3"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "hasql_pool_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "hasql_pool_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "hasql_pool_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "hasql_pool_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "hasql_pool_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "hasql_pool_sysconfdir") (\_ -> return sysconfdir)
